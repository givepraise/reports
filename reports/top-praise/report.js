...
export default class Report extends BaseReport {
  ...
  async run() {
    ...
    let sql = `SELECT 
        ...
        rac.accountId AS giver_useraccounts_accountId, rac.user as giver_useraccounts_user, rac.name AS receiver_useraccounts_name, rac.avatarId AS receiver_useraccounts_avatarId, rac.platform AS receiver_useraccounts_platform, rac.createdAt AS receiver_useraccounts_createdAt, rac.updatedAt AS receiver_useraccounts_updatedAt
      FROM praises AS p
