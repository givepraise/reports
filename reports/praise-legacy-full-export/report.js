  ...
  async run() {
    ...
    let sql = `
      ...
      SELECT 
        id,
        date,
        to_user_account as "to user account",
        to_user_account_id as "to user account id",
        to_eth_address as "to eth address", 
        from_user_account as "from user account",
        from_user_account_id as "from user account id",
        from_eth_address as "from eth address",
        reason,
